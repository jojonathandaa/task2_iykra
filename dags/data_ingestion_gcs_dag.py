...
PROJECT_ID = os.environ.get('GCP_PROJECT_ID', 'crypto-trail-369705')
BUCKET = os.environ.get('GCP_GCS_BUCKET', 'data-fellowhip-8')
...
BIGQUERY_DATASET = os.environ.get('BIGQUERY_DATASET', 'task2_iykra')
    ...
    bigquery_external_table_task = BigQueryCreateExternalTableOperator(
        ...
        table_resource={
            ...
            "externalDataConfiguration": {
                ...
                "sourceUris": [f"gs://{BUCKET}/data_raw_jonathan/{parquet_file}"],
            },
        },
    )
